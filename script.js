...
menuIcon.classList.remove('bx-x');
  ...
  const typed = new Typed('.multiple-text', {
    strings: ['Frontend Developer','Software Developer ','Backend Developer'],
    typeSpeed:300,
    backSpeed:200,
    backDelay:1000,
    loop:true
...
// Define a function to handle smooth scrolling
